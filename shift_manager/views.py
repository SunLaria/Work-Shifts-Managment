...
def home(request,week_num=datetime.datetime.now().isocalendar()[1]-1):
    ...
    return render(request, "shift_manager/index.html", {"week_dates":dates,"week_num":week_num,"workers_list":[{"Worker_ID":i.Worker_ID,"Full_Name":i.Full_Name} for i in Worker.objects.all()],"shifts_data":Shift.objects.all()})
